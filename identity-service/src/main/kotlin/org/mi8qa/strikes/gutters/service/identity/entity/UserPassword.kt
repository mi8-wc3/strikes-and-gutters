...
/**
 * Represents a UserPassword entity in the database.
 *
 ...
 * @property createdDate The date and time when the password was created.
 * @property modifiedDate The date and time when the password was last modified.
 */
